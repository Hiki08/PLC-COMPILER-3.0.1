...
def ReadCSB6400802():
    ...
    try:
        ...
        # wb = load_workbook(filename='CSB6400802 NEW 2.xlsm', data_only=True)
        # sheet = wb['format']
        # CSB6400802Data = pd.DataFrame(sheet.values)
        # CSB6400802Data = CSB6400802Data.replace(r'\s+', '', regex=True)

        workbook = CalamineWorkbook.from_path("CSB6400802 NEW 2.xlsm")
    ...
    # CSB6400802Data = pd.read_excel('CSB6400802 NEW 2.xlsm', sheet_name='format', engine='calamine')
    # CSB6400802Data = CSB6400802Data.replace(r'\s+', '', regex=True)
...
# %%
# ReadEM0580106P()
# GettingEM6P("CAT-4J15DI")

# %%
# ReadCSB6400802()

# %%
# GettingCSB6400802("102824A")
