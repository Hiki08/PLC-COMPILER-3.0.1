...
def ReadFM05000102():
    ...
    # FM05000102Data = pd.read_excel('FM05000102 NEW.xlsm', sheet_name='format', engine='openpyxl')
    # FM05000102Data = FM05000102Data.replace(r'\s+', '', regex=True)
...
def ReadEM0580106P():
    ...
    # EM0580106PData = pd.read_excel('EM0580106P NEW.xlsm', sheet_name='format', engine='openpyxl')
    # EM0580106PData = EM0580106PData.replace(r'\s+', '', regex=True)
...
def ReadEM0580107P():
    ...
    # EM0580107PData = pd.read_excel('EM0580107P NEW.xlsm', sheet_name='format', engine='openpyxl')
    # EM0580107PData = EM0580107PData.replace(r'\s+', '', regex=True)
